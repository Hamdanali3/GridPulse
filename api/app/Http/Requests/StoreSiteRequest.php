...
class StoreSiteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => ['required', 'string', 'regex:/^[A-Z]{3}-[A-Z0-9]{2,4}-\d{2,3}$/', Rule::unique('sites', 'code')],
            'type' => ['required', Rule::enum(SiteType::class)],
            'capacity_mw' => ['required', 'numeric', 'min:0.1', 'max:5000'],
    ...
    public function messages(): array
    {
        return [
            ...
            'capacity_mw.min' => 'Capacity must be at least 0.1 MW.',
        ];
    }
}
